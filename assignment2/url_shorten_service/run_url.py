...
from services.IDPool import IDPool
...
id_generator = IDGenerator(shuffle=shuffle, mode=MODE)
pool = IDPool(id_generator)


def check_expired_urls():
    with connect_db() as conn:
        deleted_ids = delete_expired_urls(conn)
    pool.release_batch(deleted_ids)
